...
public class DataInitializer {
        ...
        private List<Question> getDSAQuestions() {
                ...
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                "Which data structure provides average O(1) lookup time?",
                                List.of("Array", "Linked List", "Hash Table", "Binary Tree"), "Hash Table"));
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY,
                                "Which traversal of a binary search tree outputs sorted values?",
                                List.of("Preorder", "Postorder", "Level-order", "Inorder"), "Inorder"));
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                "What happens to time complexity when a recursive algorithm recomputes overlapping subproblems?",
                                List.of("Becomes linear", "Becomes exponential", "Remains constant",
                                                "Becomes logarithmic"),
                                "Becomes exponential"));
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                ...
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                List.of("Min-heap", "Self-balancing BST", "B-Tree", "Graph"),
                                "Self-balancing BST"));
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                "Which sorting algorithm has the best average-case performance?",
                                List.of("Bubble Sort", "Merge Sort", "Insertion Sort", "Selection Sort"),
                                "Merge Sort"));
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY,
                ...
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                List.of("Nodes", "Pointers", "Null ending", "Values"),
                                "Null ending"));
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                ...
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                List.of("O(n)", "O(k)", "O(h + k) where h is height", "O(log n)"),
                                "O(h + k) where h is height"));
                q.add(new Question(null, QuestionTopic.DATA_STRUCTURES_AND_ALGORITHMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
        ...
        private List<Question> getSystemsQuestions() {
                ...
                q.add(new Question(
                                null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What is a kernel?",
                ...
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM, "What is thrashing?",
                                ...
                                "Excessive paging lead by the OS spending more time swapping than executing"));
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What does BIOS stand for?",
                                List.of("Binary Input Output System", "Basic Input Output System",
                                                "Better Input Output System",
                                                "Basic Internal OS"),
                                "Basic Input Output System"));
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM, "What is a shell?",
                ...
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What is cache memory?",
                ...
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What is an interrupt?",
                ...
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "A bit indicating a page has been modified since it was loaded"));
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY,
                                "Which file system is standard for Windows?", List.of("EXT4", "FAT32", "NTFS", "HFS+"),
                                "NTFS"));
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is a 'Spinlock'?",
                                ...
                                "A lock where a thread actively waits (loops) until the lock is available"));
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                ...
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is copy-on-write (COW)?",
                ...
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                                ...
                                "Hard systems have strict deadlines; missing them causes failure. Soft systems have flexible deadlines"));
                q.add(new Question(null, QuestionTopic.SYSTEMS, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM, "What is a zombie process?",
        ...
        private List<Question> getNetworkingQuestions() {
                List<Question> q = new ArrayList<>();
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                "Which protocol guarantees reliable data delivery?",
                                List.of("UDP", "IP", "TCP", "HTTP"), "TCP"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY, "What does DNS stand for?",
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM, "What is a 'socket'?",
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                List.of("Data Link Layer", "Transport Layer", "Network Layer", "Session Layer"),
                                "Network Layer"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY,
                                "Which of these is a connectionless protocol?", List.of("TCP", "UDP", "SSH", "FTP"),
                                "UDP"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "Defining the network and host portions of an IP address"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What does ICMP stand for?",
                                List.of("Internet Control Message Protocol", "Internal Communication Management Port",
                                                "Instant Connection Message Protocol",
                                                "Internet Cache Management Protocol"),
                                "Internet Control Message Protocol"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                "A 'Three-way Handshake' is used by which protocol?",
                                List.of("UDP", "TCP", "ICMP", "IP"), "TCP"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY,
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM, "What is 'bandwidth'?",
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                "What is the difference between IPv4 and IPv6?", List.of("IPv6 is 32-bit",
                                                ...
                                                "IPv6 has fewer addresses"),
                                "IPv6 uses 128-bit addresses"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What is MAC address?",
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "To allow multiple network applications to run on one device"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "A switch sends data only to the intended recipient; a hub broadcasts to all"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME, "What is TCP slow start?",
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM, "What is a VPN?",
                ...
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                                ...
                                "Flow control manages sender speed for receiver; congestion control manages network capacity"));
                q.add(new Question(null, QuestionTopic.NETWORKING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is a reverse proxy?",
        ...
        private List<Question> getDatabaseQuestions() {
                List<Question> q = new ArrayList<>();
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                "What does an index primarily improve?",
                                List.of("Insert speed", "Delete speed", "Query lookup speed", "Transaction safety"),
                                "Query lookup speed"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                ...
                                List.of("Integrity", "Iteration", "Isolation", "Immutability"),
                                "Isolation"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "Need for flexible schema or horizontal scalability"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What does SQL stand for?",
                                List.of("Simple Query Language", "Structured Query Language", "Standard Query Level",
                                                "Sequential Query Library"),
                                "Structured Query Language"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM, "What is a Foreign Key?",
                ...
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY,
                                ...
                                List.of("ADD", "INSERT", "UPDATE", "CREATE"),
                                "INSERT"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is a 'covering index'?",
                ...
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "A transaction is treated as a single unit, which either succeeds completely or fails completely"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is Sharding?",
                ...
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                List.of("Consistency, Availability, and Performance",
                                                ...
                                                "Caching, Availability, and Performance"),
                                "Consistency, Availability, and Partition Tolerance - pick two"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                "Ensuring data changes are recorded in a log before being applied to the database"));
                q.add(new Question(
                                null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY, "What is a Primary Key?",
                ...
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What is a Database Schema?",
                ...
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                "A transaction sees new rows added by another transaction that wasn't there before"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                ...
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                                ...
                                "Frequency of access: hot is frequently accessed, cold is rarely accessed"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is replication lag?",
                ...
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                                ...
                                "A process that flushes dirty pages to disk and marks what has been persisted"));
                q.add(new Question(null, QuestionTopic.DATABASES, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is connection pooling?",
        ...
        private List<Question> getConcurrencyQuestions() {
                List<Question> q = new ArrayList<>();
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                "What is a race condition?",
                                List.of("Threads competing for CPU time",
                                                "Multiple threads accessing shared data unsafely",
                                                "Dead threads", "Infinite loops"),
                                "Multiple threads accessing shared data unsafely"));
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                "Which condition is required for a deadlock?",
                                List.of("Preemption", "Mutual exclusion", "Parallelism", "Caching"),
                                "Mutual exclusion"));
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                ...
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                List.of("Pessimistic locking is faster",
                                                ...
                                                "Pessimistic locking is only for read-only data"),
                                "Optimistic locking assumes conflicts are rare and checks at commit; pessimistic locking locks data upfront"));
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                ...
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                "Lazy initialization in a thread-safe manner with minimal overhead"));
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY,
                ...
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                "A thread sees a value is 'A', then 'B', then 'A' again, and mistakenly assumes nothing changed"));
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What is a 'Semaphore'?",
                ...
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "A synchronization aid that allows one or more threads to wait until a set of operations completes"));
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is 'Livelock'?",
                                List.of("A crash",
                ...
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                ...
                                List.of("Integer", "AtomicInteger", "VolatileInteger", "ThreadSafeInt"),
                                "AtomicInteger"));
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What is 'Parallelism'?",
                ...
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                "Parallel execution of tasks that can be broken into smaller subtasks recursively"));
                q.add(new Question(null, QuestionTopic.CONCURRENCY, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
        ...
        private List<Question> getSoftwareDesignQuestions() {
                List<Question> q = new ArrayList<>();
                q.add(new Question(null, QuestionTopic.SOFTWARE_DESIGN, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                ...
                q.add(new Question(null, QuestionTopic.SOFTWARE_DESIGN, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                "Which design pattern decouples object creation from usage?",
                                List.of("Singleton", "Factory", "Observer", "Decorator"), "Factory"));
                q.add(new Question(null, QuestionTopic.SOFTWARE_DESIGN, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                ...
                q.add(new Question(null, QuestionTopic.SOFTWARE_DESIGN, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "Encapsulating a request as an object, thereby letting you parameterize clients with different requests"));
                q.add(new Question(null, QuestionTopic.SOFTWARE_DESIGN, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
        ...
        private List<Question> getDebuggingQuestions() {
                List<Question> q = new ArrayList<>();
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                ...
                                "Reproduce the issue"));
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is a 'Heisenbug'?",
                ...
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                ...
                                "Explaining your code line-by-line to an inanimate object"));
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM, "What is a 'Breakpoint'?",
                ...
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                "Comparing a working version of the code with a non-working version to find the cause of a bug"));
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What is a 'Stack Trace'?",
                                List.of(
                                ...
                                "A report that shows the active stack frames at a certain point in time during the execution of a program"));
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM, "What is a 'Watchpoint'?",
                ...
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "An isolated environment for testing and debugging code safely"));
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                ...
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                                ...
                                "Automated testing that provides random or malformed data as input to find bugs"));
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is a core dump?",
                ...
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                List.of("A breakpoint that only works sometimes",
                                                ...
                                                "An if statement"),
                                "A breakpoint that triggers only when a specified condition is true"));
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME, "What is delta debugging?",
                                ...
                                "A technique that systematically narrows down failure-inducing input to a minimal subset"));
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is an assertion?",
                ...
                q.add(new Question(null, QuestionTopic.DEBUGGING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME, "What is taint analysis?",
        ...
        private List<Question> getCodeReasoningQuestions() {
                List<Question> q = new ArrayList<>();
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                "What does this code print?\nint x = 1;\nfor(int i = 0; i < 3; i++) x += i;\nSystem.out.println(x);",
                                List.of("3", "4", "5", "6"), "4"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                "What is the final value of x?\nint x = 10;\nif(x > 5) x += 2;\nelse x -= 2;",
                                List.of("8", "10", "12", "14"), "12"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                ...
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY,
                                "What is the output of '5' + 2 in JavaScript?",
                                List.of("7", "52", "Error", "Undefined"), "52"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC,
                                ...
                                List.of("3.33", "3", "4", "Error"),
                                "3"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                "What is the result of (true || false) && !true?",
                                List.of("true", "false", "Error", "Undefined"),
                                "false"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "The right side is not evaluated if the left side is false"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EASY,
                                "What is the value of 'x' after: int x = 5; x++;?", List.of("5", "6", "4", "Error"),
                                "6"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                ...
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.MEDIUM,
                                ...
                                "To handle exceptions and prevent the program from crashing"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is 'Recursion'?",
                                List.of("A fast loop", "A method that calls itself", "A type of sorting",
                                                "A way to join strings"),
                ...
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                "A function that remembers and can access its lexical scope even when it is executed outside its original scope"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.BASIC, "What is a 'Boolean'?",
                ...
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD,
                                ...
                                "The technique of translating the evaluation of a function that takes multiple arguments into evaluating a sequence of functions, each with a single argument"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                ...
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.EXTREME,
                                ...
                                "An evaluation strategy that delays expression evaluation until its value is needed"));
                q.add(new Question(null, QuestionTopic.CODE_REASONING, QuestionType.MULTIPLE_CHOICE, QuestionDifficulty.HARD, "What is immutability?",
